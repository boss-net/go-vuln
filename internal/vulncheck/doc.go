...
specifically a [github.com/boss-net/go-vuln/internal/client.Client].
The vulnerabilities
are modeled using the [github.com/boss-net/go-vuln/internal/osv] format.
...
[govulncheck]: https://pkg.go.dev/github.com/boss-net/go-vuln/cmd/govulncheck
