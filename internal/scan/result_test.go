...
func TestFrame(t *testing.T) {
	for _, test := range []struct {
	...
	}{
		{
			...
			frame: &govulncheck.Frame{
				Package:  "github.com/boss-net/go-vuln/internal/vulncheck",
				Function: "Foo",
				Position: &govulncheck.Position{Filename: "some/path/file.go", Line: 12},
			},
			wantFunc: "github.com/boss-net/go-vuln/internal/vulncheck.Foo",
		...
		},
		{
			...
			wantFunc: "github.com/boss-net/go-vuln/internal/vulncheck.Bar.Foo",
		},
		{
